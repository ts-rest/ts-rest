...
<Callout type="note">
  ...
  documentation](/server/nest#configuration).
</Callout>
...
**Workaround:** Use ts-rest's [path prefix feature](/contract/overview#path-prefix) in your contract definition to achieve similar functionality.
