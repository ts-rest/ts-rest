...
In a brownfield code base it's common that you may not have the luxury of having Typescript end to end, possibly you've got a Android/iOS/Flutter app that's written in Java/Kotlin/Swift and you're looking to add Typescript to your backend.
