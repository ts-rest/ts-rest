...
const suspenseWrapper = ({ children }: { children: React.ReactNode }) => (
  <QueryClientProvider client={queryClient}>
    <ErrorBoundary fallbackRender={({ error }) => <p>{error.body.message}</p>}>
...
describe('react-query', () => {
  ...
  it('useSuspenseQuery should handle success', async () => {
    ...
    const { result } = renderHook(
      () =>
        client.health.useSuspenseQuery({
          queryKey: ['health'],
        }),
      {
  ...
  it('useSuspenseQueries should handle success', async () => {
    ...
    const { result } = renderHook(
      () =>
        client.posts.getPost.useSuspenseQueries({
          queries: [
            {
              queryKey: ['posts', '1'],
              request: {
  ...
  it('fetchQuery should handle success', async () => {
    ...
    renderHook(
      () => {
        ...
        return client.posts.getPost.fetchQuery(queryClient, {
          queryKey: ['post', '1'],
          request: {
            params: {
              id: '1',
  ...
  it('fetchQuery should handle success hook', async () => {
    ...
    renderHook(
      () => {
        ...
        return apiQueryClient.posts.getPost.fetchQuery({
          queryKey: ['post', '1'],
          request: {
            params: {
              id: '1',
  ...
  it('fetchQuery should handle failure', async () => {
    ...
    const { result } = renderHook(
      async () => {
        const apiQueryClient = useTsRestQueryClient(client);
        try {
          return await apiQueryClient.posts.getPost.fetchQuery({
            queryKey: ['post', '1'],
            request: {
              params: {
                id: '1',
  ...
  it('prefetchQuery should handle success', async () => {
    ...
    renderHook(
      () => {
        const apiQueryClient = useTsRestQueryClient(client);
        return apiQueryClient.posts.getPost.prefetchQuery({
          queryKey: ['post', '1'],
          request: {
            params: {
              id: '1',
  ...
  it('getQueryData should return already fetched data', async () => {
    ...
    renderHook(
      () => {
        const { data } = client.posts.getPost.useQuery({
          queryKey: ['post', '1'],
          request: {
            params: {
              id: '1',
